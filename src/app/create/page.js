...
export default function create() {
  return (
    <div className="grid grid-cols-3 items-start justify-items-end h-screen w-full">
      <Button
        className={
      ...
      <div className="col-span-1 w-full border-2 rounded-[10px] p-6 bg-white h-max flex flex-col items-start justify-start shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
        <p className="flex flex-row mt-2 font-semibold lg:text-3xl items-center gap-2">
